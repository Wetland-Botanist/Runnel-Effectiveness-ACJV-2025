...
elevs <- read.csv(paste("Elevation Analysis\\Formatted Datasets\\", Site_Name, " Corrected Elevations.csv", sep = "")) %>%
                    select(-X) %>%
...
ggsave(elevations_profiles, 
       ...
       filename = paste("Elevation Analysis\\Output Figures\\", Site_Name," ", Treatment_Name, " Elevation Profile.jpg", sep = ""))
