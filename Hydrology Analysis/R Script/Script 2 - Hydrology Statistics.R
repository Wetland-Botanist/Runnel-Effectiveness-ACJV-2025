...
#Select the name of the Creek Water Level Recorder to analyze the hydrology
Creek_Logger <- "Creek"
...
# Calculate the high and low tide using the HL() function
...
# Quality Control -- double-check and remove any double low tides from the datasets
